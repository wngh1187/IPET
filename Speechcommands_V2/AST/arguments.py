...
def get_args():
    ...
    parser.add_argument('-norm_mean', type = float, default = -6.845978) 
    parser.add_argument('-norm_std', type = float, default = 5.5654526) 
    ...
    parser.add_argument('-timem', type = int, default = 48)  
