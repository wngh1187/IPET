...
def get_args():
    ...
    parser.add_argument('-path_musan', type=str, default='/DB/musan')
    parser.add_argument('-path_rir', type=str, default='/DB/rir_noises/simulated_rirs')
    ...
    #data processing
    parser.add_argument('-frame_length', type = int, default = 300) 
