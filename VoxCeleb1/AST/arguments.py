...
def get_args():
    ...
    parser.add_argument('-path_training_dataset', type=str, default='../datafiles/vox1_train_data.json')
    parser.add_argument('-path_evaluation_dataset', type=str, default='../datafiles/vox1_eval_data.json')
    parser.add_argument('-path_data_label', type=str, default='../datafiles/class_labels_indices.csv')
    parser.add_argument('-path_trial', type=str, default='../vox1_trials/voxceleb1_eval.txt')
    ...
    parser.add_argument('-norm_mean', type = float, default = -4.8955183) 
    parser.add_argument('-norm_std', type = float, default = 4.2524743) 
    parser.add_argument('-skip_norm', type = str2bool, nargs='?', const=True, default = False)
    parser.add_argument('-nb_seg', type = int, default = 5) 

    #data augmentation
    parser.add_argument('-mixup', type = float, default = 0) 
    parser.add_argument('-freqm', type = int, default = 48) 
    parser.add_argument('-timem', type = int, default = 80)  
    parser.add_argument('-add_noise', type = str2bool, nargs='?', const=True, default = True)
