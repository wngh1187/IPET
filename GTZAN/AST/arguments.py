...
def get_args():
    ...
    parser.add_argument('-path_training_dataset', type=str, default='../datafiles/gtzan_train_data.json')
    parser.add_argument('-path_evaluation_dataset', type=str, default='../datafiles/gtzan_eval_data.json')
    ...
    parser.add_argument('-embedding_prompt_num', type=int, default=8)
    ...
    parser.add_argument('-norm_mean', type = float, default = -2.37300301) 
    parser.add_argument('-norm_std', type = float, default = 3.19099191) 
    parser.add_argument('-skip_norm', type = str2bool, nargs='?', const=True, default = False)
    parser.add_argument('-nb_seg', type = int, default = 10) 
